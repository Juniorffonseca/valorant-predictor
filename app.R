...
##### PROBLEMA QUE SURGIU: COMO LIDAR COM A QUESTÃO DE NORMALIZAR DADOS NA BASE DE TREINAMENTO MAS PARA FAZER A PREVISÃO 
##### NÃO CONSEGUIR NORMALIZAR EM 1 CONFRONTO ESPECIFICO?
